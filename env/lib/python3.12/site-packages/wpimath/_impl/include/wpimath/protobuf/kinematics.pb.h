...
class ProtobufDifferentialDriveWheelPositions;
struct ProtobufDifferentialDriveWheelPositionsDefaultTypeInternal;
extern ProtobufDifferentialDriveWheelPositionsDefaultTypeInternal _ProtobufDifferentialDriveWheelPositions_default_instance_;
...
template<> ::wpi::proto::ProtobufDifferentialDriveWheelPositions* Arena::CreateMaybeMessage<::wpi::proto::ProtobufDifferentialDriveWheelPositions>(Arena*);
...
class ProtobufDifferentialDriveWheelPositions final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:wpi.proto.ProtobufDifferentialDriveWheelPositions) */ {
 public:
  inline ProtobufDifferentialDriveWheelPositions() : ProtobufDifferentialDriveWheelPositions(nullptr) {}
  ~ProtobufDifferentialDriveWheelPositions() override;
  explicit PROTOBUF_CONSTEXPR ProtobufDifferentialDriveWheelPositions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ProtobufDifferentialDriveWheelPositions(const ProtobufDifferentialDriveWheelPositions& from);
  ProtobufDifferentialDriveWheelPositions(ProtobufDifferentialDriveWheelPositions&& from) noexcept
    : ProtobufDifferentialDriveWheelPositions() {
    *this = ::std::move(from);
  }

  inline ProtobufDifferentialDriveWheelPositions& operator=(const ProtobufDifferentialDriveWheelPositions& from) {
    CopyFrom(from);
    return *this;
  }
  inline ProtobufDifferentialDriveWheelPositions& operator=(ProtobufDifferentialDriveWheelPositions&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ProtobufDifferentialDriveWheelPositions& default_instance() {
    return *internal_default_instance();
  }
  static inline const ProtobufDifferentialDriveWheelPositions* internal_default_instance() {
    return reinterpret_cast<const ProtobufDifferentialDriveWheelPositions*>(
               &_ProtobufDifferentialDriveWheelPositions_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(ProtobufDifferentialDriveWheelPositions& a, ProtobufDifferentialDriveWheelPositions& b) {
    a.Swap(&b);
  }
  inline void Swap(ProtobufDifferentialDriveWheelPositions* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ProtobufDifferentialDriveWheelPositions* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ProtobufDifferentialDriveWheelPositions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ProtobufDifferentialDriveWheelPositions>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ProtobufDifferentialDriveWheelPositions& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ProtobufDifferentialDriveWheelPositions& from) {
    ProtobufDifferentialDriveWheelPositions::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ProtobufDifferentialDriveWheelPositions* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "wpi.proto.ProtobufDifferentialDriveWheelPositions";
  }
  protected:
  explicit ProtobufDifferentialDriveWheelPositions(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
// double left = 1;
inline void ProtobufDifferentialDriveWheelPositions::clear_left() {
  _impl_.left_ = 0;
}
inline double ProtobufDifferentialDriveWheelPositions::_internal_left() const {
  return _impl_.left_;
}
inline double ProtobufDifferentialDriveWheelPositions::left() const {
  // @@protoc_insertion_point(field_get:wpi.proto.ProtobufDifferentialDriveWheelPositions.left)
  return _internal_left();
}
inline void ProtobufDifferentialDriveWheelPositions::_internal_set_left(double value) {
  
  _impl_.left_ = value;
}
inline void ProtobufDifferentialDriveWheelPositions::set_left(double value) {
  _internal_set_left(value);
  // @@protoc_insertion_point(field_set:wpi.proto.ProtobufDifferentialDriveWheelPositions.left)
}

// double right = 2;
inline void ProtobufDifferentialDriveWheelPositions::clear_right() {
  _impl_.right_ = 0;
}
inline double ProtobufDifferentialDriveWheelPositions::_internal_right() const {
  return _impl_.right_;
}
inline double ProtobufDifferentialDriveWheelPositions::right() const {
  // @@protoc_insertion_point(field_get:wpi.proto.ProtobufDifferentialDriveWheelPositions.right)
  return _internal_right();
}
inline void ProtobufDifferentialDriveWheelPositions::_internal_set_right(double value) {
  
  _impl_.right_ = value;
}
inline void ProtobufDifferentialDriveWheelPositions::set_right(double value) {
  _internal_set_right(value);
  // @@protoc_insertion_point(field_set:wpi.proto.ProtobufDifferentialDriveWheelPositions.right)
}

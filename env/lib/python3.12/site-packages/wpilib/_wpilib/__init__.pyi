...
class SensorUtil:
    ...
    """
    kAnalogInputs: typing.ClassVar[int] = 8
    kAnalogOutputs: typing.ClassVar[int] = 2
    kDigitalChannels: typing.ClassVar[int] = 31
    kPwmChannels: typing.ClassVar[int] = 20
    kRelayChannels: typing.ClassVar[int] = 4
    @staticmethod
